...
export function initializeEventListeners() {
  ...
  const difficultySettingsBlock = mainMenuScreen.querySelector('[data-menu-id="settings-difficulty"]');
  const difficultySettingsButton = difficultySettingsBlock ? difficultySettingsBlock.querySelector('#difficulty-settings-button') : null;
